...
<?php include("../page/menu_admin.php");?>
    ...
    <?php include("../page/nav_bar_admin.php");?>
        ...
        <div class="col-lg-12">
      <div class="card">
        <div class="card-header">Ajouter une photo</div>
            <div class="card-body card-block">
                <form action="../controler/Ajouter_Photo.php" method="post" class="" enctype="multipart/form-data"> 
                     <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon"></div>
                                <input type="text" id="username" name="nom" placeholder="Nom du photo" class="form-control">
                            </div>
                        </div>
