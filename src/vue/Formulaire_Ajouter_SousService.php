...
<?php include("../page/menu_admin.php");?>
    ...
    <?php include("../page/nav_bar_admin.php");?>
        ...
        <div class="col-lg-12">
      <div class="card">
        <div class="card-header">Ajouter un sous-service</div>
            <div class="card-body card-block">
                <form action="../controler/AjouterSousService.php" method="post" class="" enctype="multipart/form-data"> 
                     <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-addon"></div>
                                <input type="text" id="username" name="nom" placeholder="Nom du sous-service" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="service">
                                ...
                                {?>
                                    <option value="<?php echo $valeur["idS"];?>"><?php echo $valeur["nomS"];?></option>
                                <?php }?>
                            </select>
                        </div>
                            <br/>
